...
\input{/home/cav/haliver/Experiments/HaliVerExperiments/results/exp-mem.tex}
\end{table}
\begin{table}[t]
\centering
\caption{\label{tab:chp6-results-exp}Verification results for the experiments of HaliVer from Chapter 4.}
\input{/home/cav/haliver/Experiments/HaliVerExperiments/results/exp.tex}
\end{table}
\begin{table}[t]
\centering
...
\input{/home/cav/haliver/Experiments/HaliVerExperiments/results/padre.tex}
\end{table}
\end{document}