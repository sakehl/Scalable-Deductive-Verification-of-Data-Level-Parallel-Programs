...
@*/
int gemm_0_non_unique(struct halide_buffer_int32_t *_A__buffer, struct halide_buffer_int32_t *_B__buffer, struct halide_buffer_int32_t *_C__buffer, struct halide_buffer_int32_t *_result_buffer) {
 ...
 /*@
  ...
  loop_invariant (\forall int _result_s0_j_forall, int _result_s0_i_forall; 0 <= _result_s0_j_forall && _result_s0_j_forall < _result_s0_j && 0 <= _result_s0_i_forall && _result_s0_i_forall < 2048; 0 <= {:_result[_result_s0_j_forall*2048 + _result_s0_i_forall]:} && _result[_result_s0_j_forall*2048 + _result_s0_i_forall] <= 20480300);
 @*/
 for (int _result_s0_j = 0; _result_s0_j < 0 + 2048; _result_s0_j++)
 {
  ...
  /*@
   ...
   loop_invariant (\forall int _result_s0_i_forall; 0 <= _result_s0_i_forall && _result_s0_i_forall < _result_s0_i; 0 <= {:_result[_result_s0_j*2048 + _result_s0_i_forall]:} && _result[_result_s0_j*2048 + _result_s0_i_forall] <= 20480300);
  @*/
