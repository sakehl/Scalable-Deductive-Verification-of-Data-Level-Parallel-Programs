...
/*@
 ...
 context buffer_const_double(_next_sol__buffer, 1\2, 4);
 ...
 context \pointer_length(_next_solutions__1_buffer->host) == _next_solutions__1_buffer->shape.dim[3].extent * _next_solutions__1_buffer->shape.dim[3].stride;
 ...
 context _next_solutions__1_buffer->shape.dim[2].min == 0 && _next_solutions__1_buffer->shape.dim[2].extent == _n_solutions && _next_solutions__1_buffer->shape.dim[2].stride == 1*2*2;
 context _next_solutions__1_buffer->shape.dim[3].min == 0 && _next_solutions__1_buffer->shape.dim[3].extent == _n_antennas && _next_solutions__1_buffer->shape.dim[3].stride == 1*2*2*_n_solutions;
 context (\forall* int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 0 + 2 && 0 <= _1 && _1 < 0 + 2 && 0 <= _2 && _2 < 0 + _n_solutions && 0 <= _3 && _3 < 0 + _n_antennas; Perm({:_next_solutions__1_buffer->host[_3*_n_solutions*4 + _2*4 + _1*2 + _0]:}, 1\1));
 context_everywhere 0 < min(min(_n_antennas, _n_vis), _n_solutions) && _n_antennas == 50 && _n_solutions == 8 && _n_vis == 230930 && _n_dir_sol == 3;
@*/
int StepHalide(int32_t _n_vis, int32_t _n_solutions, int32_t _n_antennas, bool _phase_only, double _step_size, struct halide_buffer_const_double *_sol__buffer, struct halide_buffer_const_double *_next_sol__buffer, int32_t _n_dir_sol, /*@unique_pointer_field<host, 1>@*/ struct halide_buffer_double *_next_solutions__1_buffer) {
 /*@immutable*/ double* _next_sol_ = _halide_buffer_get_host_const_double(_next_sol__buffer);
 ...
 if (_phase_only)
 {
  /*@
   ...
   loop_invariant (\forall* int _next_solutions__1_s0_a_forall, int _next_solutions__1_s0_si_forall, int _next_solutions__1_s0_i_forall, int _next_solutions__1_s0_c_forall; 0 <= _next_solutions__1_s0_a_forall && _next_solutions__1_s0_a_forall < _n_antennas && 0 <= _next_solutions__1_s0_si_forall && _next_solutions__1_s0_si_forall < _n_solutions && 0 <= _next_solutions__1_s0_i_forall && _next_solutions__1_s0_i_forall < 2 && 0 <= _next_solutions__1_s0_c_forall && _next_solutions__1_s0_c_forall < 2; Perm({:_next_solutions__1[((_n_solutions*_next_solutions__1_s0_a_forall + _next_solutions__1_s0_si_forall)*2 + _next_solutions__1_s0_i_forall)*2 + _next_solutions__1_s0_c_forall]:}, 1\1));
  @*/
  for (int _next_solutions__1_s0_a = 0; _next_solutions__1_s0_a < 0 + _n_antennas; _next_solutions__1_s0_a++)
  {
   int32_t _t9971 = (_next_solutions__1_s0_a * _sol__stride_3);
   int32_t _t9973 = (_next_solutions__1_s0_a * _next_solutions__1_stride_3);
   int32_t _t9972 = (_next_sol__stride_3 * _next_solutions__1_s0_a);
   /*@
    loop_invariant 0 <= _next_solutions__1_s0_si && _next_solutions__1_s0_si <= 0 + _n_solutions;
    loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < _n_solutions && 0 <= _3 && _3 < _n_antennas; {:_next_sol_[((_3*_n_solutions + _2)*2 + _1)*2 + _0]:} == pure_next_sol_(((_3*_n_solutions + _2)*2 + _1)*2 + _0));
    loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < _n_solutions && 0 <= _3 && _3 < _n_antennas; {:_sol_[((_3*_n_solutions + _2)*2 + _1)*2 + _0]:} == pure_sol_(((_3*_n_solutions + _2)*2 + _1)*2 + _0));
    loop_invariant lemma_1d_access(_next_solutions__1_s0_a, 0, _n_solutions*4, _n_antennas);
    loop_invariant (\forall* int _next_solutions__1_s0_si_forall, int _next_solutions__1_s0_i_forall, int _next_solutions__1_s0_c_forall; 0 <= _next_solutions__1_s0_si_forall && _next_solutions__1_s0_si_forall < _n_solutions && 0 <= _next_solutions__1_s0_i_forall && _next_solutions__1_s0_i_forall < 2 && 0 <= _next_solutions__1_s0_c_forall && _next_solutions__1_s0_c_forall < 2; Perm({:_next_solutions__1[_n_solutions*_next_solutions__1_s0_a*4 + (_next_solutions__1_s0_si_forall*2 + _next_solutions__1_s0_i_forall)*2 + _next_solutions__1_s0_c_forall]:}, 1\1));
   @*/
   for (int _next_solutions__1_s0_si = 0; _next_solutions__1_s0_si < 0 + _n_solutions; _next_solutions__1_s0_si++)
   {
    int32_t _t9974 = (_next_solutions__1_s0_si * 2);
    /*@
     loop_invariant 0 <= _next_solutions__1_s0_i && _next_solutions__1_s0_i <= 0 + 2;
     loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < _n_solutions && 0 <= _3 && _3 < _n_antennas; {:_next_sol_[((_3*_n_solutions + _2)*2 + _1)*2 + _0]:} == pure_next_sol_(((_3*_n_solutions + _2)*2 + _1)*2 + _0));
     loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < _n_solutions && 0 <= _3 && _3 < _n_antennas; {:_sol_[((_3*_n_solutions + _2)*2 + _1)*2 + _0]:} == pure_sol_(((_3*_n_solutions + _2)*2 + _1)*2 + _0));
     loop_invariant lemma_1d_access(_next_solutions__1_s0_a, 0, _n_solutions*4, _n_antennas) && true;
     loop_invariant (\forall* int _next_solutions__1_s0_i_forall, int _next_solutions__1_s0_c_forall; 0 <= _next_solutions__1_s0_i_forall && _next_solutions__1_s0_i_forall < 2 && 0 <= _next_solutions__1_s0_c_forall && _next_solutions__1_s0_c_forall < 2; Perm({:_next_solutions__1[_next_solutions__1_s0_si*4 + _n_solutions*_next_solutions__1_s0_a*4 + _next_solutions__1_s0_i_forall*2 + _next_solutions__1_s0_c_forall]:}, 1\1));
    @*/
    for (int _next_solutions__1_s0_i = 0; _next_solutions__1_s0_i < 0 + 2; _next_solutions__1_s0_i++)
    {
     {
      /*@unique<2>@*/ double _distance[1];
      // produce distance
      int32_t _t9958 = (_next_solutions__1_s0_i + _t9974);
      int32_t _t9959 = ((_t9958 * 2) + _t9971);
      int32_t _t9960 = ((_t9958 * 2) + _t9972);
      double _1274 = _sol_[lemma_4d_access_concrete((_t9959 + 1), 1, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _sol__stride_3, _n_antennas)];
      double _1275 = _sol_[lemma_4d_access_concrete(_t9959, 0, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _sol__stride_3, _n_antennas)];
      double _1276 = _next_sol_[lemma_4d_access_concrete((_t9960 + 1), 1, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _next_sol__stride_3, _n_antennas)];
      double _1277 = _next_sol_[lemma_4d_access_concrete(_t9960, 0, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _next_sol__stride_3, _n_antennas)];
      _distance[0]= (atan2_f64(_1274, _1275) - atan2_f64(_1276, _1277));
      double _1278 = _distance[0];
      double _t9946 = _1278;
      _distance[0]= (((3.141593 < _t9946) ? -6.283185 : 6.283185) + _t9946);
      // consume distance
      int32_t _t9961 = (_next_solutions__1_s0_i + _t9974);
      int32_t _t9962 = ((_t9961 * 2) + _t9971);
      double _1279 = _sol_[lemma_4d_access_concrete((_t9962 + 1), 1, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _sol__stride_3, _n_antennas)];
      double _1280 = _sol_[lemma_4d_access_concrete(_t9962, 0, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _sol__stride_3, _n_antennas)];
      double _1281 = _distance[0];
      _next_solutions__1[lemma_4d_access_concrete(((_t9961 * 2) + _t9973), 0, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _next_solutions__1_stride_3, _n_antennas)]= cos_f64((atan2_f64(_1279, _1280) + (_1281 * _step_size)));
     } // alloc _distance
     {
      /*@unique<3>@*/ double _distance[1];
      // produce distance
      int32_t _t9963 = (_next_solutions__1_s0_i + _t9974);
      int32_t _t9964 = ((_t9963 * 2) + _t9971);
      int32_t _t9965 = ((_t9963 * 2) + _t9972);
      double _1282 = _sol_[lemma_4d_access_concrete((_t9964 + 1), 1, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _sol__stride_3, _n_antennas)];
      double _1283 = _sol_[lemma_4d_access_concrete(_t9964, 0, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _sol__stride_3, _n_antennas)];
      double _1284 = _next_sol_[lemma_4d_access_concrete((_t9965 + 1), 1, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _next_sol__stride_3, _n_antennas)];
      double _1285 = _next_sol_[lemma_4d_access_concrete(_t9965, 0, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _next_sol__stride_3, _n_antennas)];
      _distance[0]= (atan2_f64(_1282, _1283) - atan2_f64(_1284, _1285));
      double _1286 = _distance[0];
      double _t9952 = _1286;
      _distance[0]= (((3.141593 < _t9952) ? -6.283185 : 6.283185) + _t9952);
      // consume distance
      int32_t _t9966 = (_next_solutions__1_s0_i + _t9974);
      int32_t _t9967 = ((_t9966 * 2) + _t9971);
      double _1287 = _sol_[lemma_4d_access_concrete((_t9967 + 1), 1, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _sol__stride_3, _n_antennas)];
      double _1288 = _sol_[lemma_4d_access_concrete(_t9967, 0, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _sol__stride_3, _n_antennas)];
      double _1289 = _distance[0];
      _next_solutions__1[lemma_4d_access_concrete((((_t9966 * 2) + _t9973) + 1), 1, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _next_solutions__1_stride_3, _n_antennas)]= sin_f64((atan2_f64(_1287, _1288) + (_1289 * _step_size)));
     } // alloc _distance
 ...
 else
 {
  ...
  for (int _next_solutions__1_s0_a = 0; _next_solutions__1_s0_a < 0 + _n_antennas; _next_solutions__1_s0_a++)
  {
   int32_t _t9976 = (_next_solutions__1_s0_a * _sol__stride_3);
   int32_t _t9979 = (_next_solutions__1_s0_a * _next_solutions__1_stride_3);
   int32_t _t9977 = (_next_sol__stride_3 * _next_solutions__1_s0_a);
   /*@
    loop_invariant 0 <= _next_solutions__1_s0_si && _next_solutions__1_s0_si <= 0 + _n_solutions;
    loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < _n_solutions && 0 <= _3 && _3 < _n_antennas; {:_next_sol_[((_3*_n_solutions + _2)*2 + _1)*2 + _0]:} == pure_next_sol_(((_3*_n_solutions + _2)*2 + _1)*2 + _0));
    loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < _n_solutions && 0 <= _3 && _3 < _n_antennas; {:_sol_[((_3*_n_solutions + _2)*2 + _1)*2 + _0]:} == pure_sol_(((_3*_n_solutions + _2)*2 + _1)*2 + _0));
   ...
   for (int _next_solutions__1_s0_si = 0; _next_solutions__1_s0_si < 0 + _n_solutions; _next_solutions__1_s0_si++)
   {
    int32_t _t9980 = (_next_solutions__1_s0_si * 2);
    int32_t _t9982 = ((_next_solutions__1_s0_si * 4) + _t9979);
    /*@
     loop_invariant 0 <= _next_solutions__1_s0_i && _next_solutions__1_s0_i <= 0 + 2;
     loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < _n_solutions && 0 <= _3 && _3 < _n_antennas; {:_next_sol_[((_3*_n_solutions + _2)*2 + _1)*2 + _0]:} == pure_next_sol_(((_3*_n_solutions + _2)*2 + _1)*2 + _0));
     loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < _n_solutions && 0 <= _3 && _3 < _n_antennas; {:_sol_[((_3*_n_solutions + _2)*2 + _1)*2 + _0]:} == pure_sol_(((_3*_n_solutions + _2)*2 + _1)*2 + _0));
    ...
    for (int _next_solutions__1_s0_i = 0; _next_solutions__1_s0_i < 0 + 2; _next_solutions__1_s0_i++)
    {
     int32_t _t9985 = ((_next_solutions__1_s0_i * 2) + _t9982);
     int32_t _t9983 = (_next_solutions__1_s0_i + _t9980);
     /*@
      loop_invariant 0 <= _next_solutions__1_s0_c && _next_solutions__1_s0_c <= 0 + 2;
      loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < _n_solutions && 0 <= _3 && _3 < _n_antennas; {:_next_sol_[((_3*_n_solutions + _2)*2 + _1)*2 + _0]:} == pure_next_sol_(((_3*_n_solutions + _2)*2 + _1)*2 + _0));
      loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < _n_solutions && 0 <= _3 && _3 < _n_antennas; {:_sol_[((_3*_n_solutions + _2)*2 + _1)*2 + _0]:} == pure_sol_(((_3*_n_solutions + _2)*2 + _1)*2 + _0));
      loop_invariant lemma_1d_access(_next_solutions__1_s0_a, 0, _n_solutions*4, _n_antennas) && true && true;
      loop_invariant (\forall* int _next_solutions__1_s0_c_forall; 0 <= _next_solutions__1_s0_c_forall && _next_solutions__1_s0_c_forall < 2; Perm({:_next_solutions__1[_next_solutions__1_s0_i*2 + _next_solutions__1_s0_si*4 + _n_solutions*_next_solutions__1_s0_a*4 + _next_solutions__1_s0_c_forall]:}, 1\1));
     @*/
     for (int _next_solutions__1_s0_c = 0; _next_solutions__1_s0_c < 0 + 2; _next_solutions__1_s0_c++)
     {
      // consume distance
      int32_t _t9969 = ((_t9983 * 2) + _t9976);
      int32_t _t9970 = ((_t9983 * 2) + _t9977);
      double _1290 = _sol_[lemma_4d_access_concrete(_t9969, 0, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _sol__stride_3, _n_antennas)];
      double _1291 = _next_sol_[lemma_4d_access_concrete(_t9970, 0, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _next_sol__stride_3, _n_antennas)];
      double _1292 = _sol_[lemma_4d_access_concrete((_t9969 + 1), 1, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _sol__stride_3, _n_antennas)];
      double _1293 = _next_sol_[lemma_4d_access_concrete((_t9970 + 1), 1, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _next_sol__stride_3, _n_antennas)];
      _next_solutions__1[lemma_4d_access_concrete((_next_solutions__1_s0_c + _t9985), _next_solutions__1_s0_c, 0, 1, 2, _next_solutions__1_s0_i, 0, 2, 2, _next_solutions__1_s0_si, 0, 4, _n_solutions, _next_solutions__1_s0_a, 0, _next_solutions__1_stride_3, _n_antennas)]= ((_next_solutions__1_s0_c == 0) ? ((_1290 * (1.000000 - _step_size)) + (_1291 * _step_size)) : ((_next_solutions__1_s0_c == 1) ? ((_1292 * (1.000000 - _step_size)) + (_1293 * _step_size)) : ((_1292 * (1.000000 - _step_size)) + (_1293 * _step_size))));
     } // for _next_solutions__1_s0_c
    } // for _next_solutions__1_s0_i
   } // for _next_solutions__1_s0_si
  } // for _next_solutions__1_s0_a
 } // if _phase_only else
