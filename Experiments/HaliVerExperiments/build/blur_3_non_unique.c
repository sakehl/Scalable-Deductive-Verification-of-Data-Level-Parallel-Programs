...
@*/
int blur_3_non_unique(struct halide_buffer_int32_t *_inp_buffer, struct halide_buffer_int32_t *_blur_y_buffer) {
 ...
 /*@
  ...
  context (\forall* int _blur_y_s0_y_yi_forall, int _blur_y_s0_x_x_forall, int _blur_y_s0_x_xi_forall; 0 <= _blur_y_s0_y_yi_forall && _blur_y_s0_y_yi_forall < 8 && 0 <= _blur_y_s0_x_x_forall && _blur_y_s0_x_x_forall < 512 && 0 <= _blur_y_s0_x_xi_forall && _blur_y_s0_x_xi_forall < 2; Perm({:_blur_y[(_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1024 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall]:}, 1\1));
  ensures (\forall int _blur_y_s0_y_yi_forall, int _blur_y_s0_x_x_forall, int _blur_y_s0_x_xi_forall; 0 <= _blur_y_s0_y_yi_forall && _blur_y_s0_y_yi_forall < 8 && 0 <= _blur_y_s0_x_x_forall && _blur_y_s0_x_x_forall < 512 && 0 <= _blur_y_s0_x_xi_forall && _blur_y_s0_x_xi_forall < 2; {:_blur_y[(_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1024 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall]:} == \euclidean_div(\euclidean_div(pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 1) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 2), 3) + \euclidean_div(pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 1026) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 1027) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 1028), 3) + \euclidean_div(pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 2052) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 2053) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 2054), 3), 3));
 @*/
 {
  {
   int64_t _2 = 10240;
   int32_t *_blur_x = (int32_t  *)malloc(sizeof(int32_t )*_2);
   //@ assume _blur_x != NULL;
   int32_t _t12 = (_blur_y_s0_y_y * 8);
   /*@
    loop_invariant 0 <= _blur_y_s0_y_yi && _blur_y_s0_y_yi <= 0 + 8;
    loop_invariant (\forall* int _0, int _1; 0 <= _0 && _0 < 1026 && 0 <= _1 && _1 < 1026; Perm({:_inp[_1*1026 + _0]:}, 1\(2*128*2*2)));
    ...
    loop_invariant (\forall* int _blur_y_s0_y_yi_forall, int _blur_y_s0_x_x_forall, int _blur_y_s0_x_xi_forall; 0 <= _blur_y_s0_y_yi_forall && _blur_y_s0_y_yi_forall < 8 && 0 <= _blur_y_s0_x_x_forall && _blur_y_s0_x_x_forall < 512 && 0 <= _blur_y_s0_x_xi_forall && _blur_y_s0_x_xi_forall < 2; Perm({:_blur_y[(_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1024 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall]:}, 1\1));
    loop_invariant (\forall int _blur_y_s0_y_yi_forall, int _blur_y_s0_x_x_forall, int _blur_y_s0_x_xi_forall; 0 <= _blur_y_s0_y_yi_forall && _blur_y_s0_y_yi_forall < _blur_y_s0_y_yi && 0 <= _blur_y_s0_x_x_forall && _blur_y_s0_x_x_forall < 512 && 0 <= _blur_y_s0_x_xi_forall && _blur_y_s0_x_xi_forall < 2; {:_blur_y[(_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1024 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall]:} == \euclidean_div(\euclidean_div(pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 1) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 2), 3) + \euclidean_div(pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 1026) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 1027) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 1028), 3) + \euclidean_div(pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 2052) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 2053) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 2054), 3), 3));
   @*/
   for (int _blur_y_s0_y_yi = 0; _blur_y_s0_y_yi < 0 + 8; _blur_y_s0_y_yi++)
   {
    // produce blur_x
    int32_t _t13 = (_blur_y_s0_y_yi + _t12);
    /*@
     loop_invariant _t13 <= _blur_x_s0_y && _blur_x_s0_y <= _t13 + 3;
     loop_invariant (\forall* int _0, int _1; 0 <= _0 && _0 < 1026 && 0 <= _1 && _1 < 1026; Perm({:_inp[_1*1026 + _0]:}, 1\(2*128*2*2*2)));
     loop_invariant (\forall int _0, int _1; 0 <= _0 && _0 < 1026 && 0 <= _1 && _1 < 1026; {:_inp[_1*1026 + _0]:} == pure_inp(_1*1026 + _0));
     loop_invariant (\forall* int _blur_x_s0_y_forall, int _blur_x_s0_x_x_forall, int _blur_x_s0_x_xi_forall; _blur_y_s0_y_y*8 + _blur_y_s0_y_yi <= _blur_x_s0_y_forall && _blur_x_s0_y_forall < _blur_y_s0_y_y*8 + _blur_y_s0_y_yi + 3 && 0 <= _blur_x_s0_x_x_forall && _blur_x_s0_x_x_forall < 512 && 0 <= _blur_x_s0_x_xi_forall && _blur_x_s0_x_xi_forall < 2; Perm({:_blur_x[(_blur_x_s0_y_forall - _blur_y_s0_y_y*8)*1024 + _blur_x_s0_x_x_forall*2 + _blur_x_s0_x_xi_forall]:}, 1\1));
     loop_invariant (\forall int _blur_x_s0_y_forall, int _blur_x_s0_x_x_forall, int _blur_x_s0_x_xi_forall; _blur_y_s0_y_y*8 + _blur_y_s0_y_yi <= _blur_x_s0_y_forall && _blur_x_s0_y_forall < _blur_x_s0_y && 0 <= _blur_x_s0_x_x_forall && _blur_x_s0_x_x_forall < 512 && 0 <= _blur_x_s0_x_xi_forall && _blur_x_s0_x_xi_forall < 2; {:_blur_x[(_blur_x_s0_y_forall - _blur_y_s0_y_y*8)*1024 + _blur_x_s0_x_x_forall*2 + _blur_x_s0_x_xi_forall]:} == \euclidean_div(pure_inp((_blur_x_s0_y_forall*513 + _blur_x_s0_x_x_forall)*2 + _blur_x_s0_x_xi_forall) + pure_inp((_blur_x_s0_y_forall*513 + _blur_x_s0_x_x_forall)*2 + _blur_x_s0_x_xi_forall + 1) + pure_inp((_blur_x_s0_y_forall*513 + _blur_x_s0_x_x_forall)*2 + _blur_x_s0_x_xi_forall + 2), 3));
    @*/
    for (int _blur_x_s0_y = _t13; _blur_x_s0_y < _t13 + 3; _blur_x_s0_y++)
    {
     int32_t _t15 = ((_blur_x_s0_y - _t12) * 512);
     int32_t _t14 = (_blur_x_s0_y * 513);
     /*@
      loop_invariant 0 <= _blur_x_s0_x_x && _blur_x_s0_x_x <= 0 + 512;
      loop_invariant (\forall* int _0, int _1; 0 <= _0 && _0 < 1026 && 0 <= _1 && _1 < 1026; Perm({:_inp[_1*1026 + _0]:}, 1\(2*128*2*2*2*2)));
      loop_invariant (\forall int _0, int _1; 0 <= _0 && _0 < 1026 && 0 <= _1 && _1 < 1026; {:_inp[_1*1026 + _0]:} == pure_inp(_1*1026 + _0));
      loop_invariant true && true;
      loop_invariant (\forall* int _blur_x_s0_x_x_forall, int _blur_x_s0_x_xi_forall; 0 <= _blur_x_s0_x_x_forall && _blur_x_s0_x_x_forall < 512 && 0 <= _blur_x_s0_x_xi_forall && _blur_x_s0_x_xi_forall < 2; Perm({:_blur_x[(_blur_x_s0_y - _blur_y_s0_y_y*8)*1024 + _blur_x_s0_x_x_forall*2 + _blur_x_s0_x_xi_forall]:}, 1\1));
      loop_invariant (\forall int _blur_x_s0_x_x_forall, int _blur_x_s0_x_xi_forall; 0 <= _blur_x_s0_x_x_forall && _blur_x_s0_x_x_forall < _blur_x_s0_x_x && 0 <= _blur_x_s0_x_xi_forall && _blur_x_s0_x_xi_forall < 2; {:_blur_x[(_blur_x_s0_y - _blur_y_s0_y_y*8)*1024 + _blur_x_s0_x_x_forall*2 + _blur_x_s0_x_xi_forall]:} == \euclidean_div(pure_inp(_blur_x_s0_y*1026 + _blur_x_s0_x_x_forall*2 + _blur_x_s0_x_xi_forall) + pure_inp(_blur_x_s0_y*1026 + _blur_x_s0_x_x_forall*2 + _blur_x_s0_x_xi_forall + 1) + pure_inp(_blur_x_s0_y*1026 + _blur_x_s0_x_x_forall*2 + _blur_x_s0_x_xi_forall + 2), 3));
     @*/
     for (int _blur_x_s0_x_x = 0; _blur_x_s0_x_x < 0 + 512; _blur_x_s0_x_x++)
     {
      int32_t _t8 = (_blur_x_s0_x_x + _t14);
      int32_t _3 = _inp[(_t8 * 2)];
      int32_t _4 = _inp[((_t8 * 2) + 1)];
      int32_t _5 = _inp[((_t8 * 2) + 2)];
      _blur_x[((_blur_x_s0_x_x + _t15) * 2)]= div_eucl((_3 + (_4 + _5)), 3);
      int32_t _t9 = (_blur_x_s0_x_x + _t14);
      int32_t _6 = _inp[((_t9 * 2) + 1)];
      int32_t _7 = _inp[((_t9 * 2) + 2)];
      int32_t _8 = _inp[((_t9 * 2) + 3)];
      _blur_x[(((_blur_x_s0_x_x + _t15) * 2) + 1)]= div_eucl((_6 + (_7 + _8)), 3);
     } // for _blur_x_s0_x_x
    } // for _blur_x_s0_y
    // consume blur_x
    int32_t _t17 = ((_blur_y_s0_y_yi + _t12) * 512);
    int32_t _t16 = (_blur_y_s0_y_yi * 512);
    /*@
     loop_invariant 0 <= _blur_y_s0_x_x && _blur_y_s0_x_x <= 0 + 512;
     loop_invariant true && true && true && true && true && true && true && true;
     loop_invariant (\forall* int _x, int _y; 0 <= _x && _x < 1024 && _blur_y_s0_y_y*8 <= _y && _y < _blur_y_s0_y_y*8 + 10; Perm({:_blur_x[(_y - _blur_y_s0_y_y*8)*1024 + _x]:}, 1\(2*2*2)));
     loop_invariant (\forall int _blur_x_s0_x, int _blur_x_s0_y; 0 <= _blur_x_s0_x && _blur_x_s0_x <= 1023 && _blur_y_s0_y_y*8 + _blur_y_s0_y_yi <= _blur_x_s0_y && _blur_x_s0_y <= _blur_y_s0_y_y*8 + _blur_y_s0_y_yi + 2; {:_blur_x[(_blur_x_s0_y - _blur_y_s0_y_y*8)*1024 + _blur_x_s0_x]:} == \euclidean_div(pure_inp(_blur_x_s0_y*1026 + _blur_x_s0_x) + pure_inp(_blur_x_s0_y*1026 + _blur_x_s0_x + 1) + pure_inp(_blur_x_s0_y*1026 + _blur_x_s0_x + 2), 3));
     loop_invariant (\forall* int _blur_y_s0_x_x_forall, int _blur_y_s0_x_xi_forall; 0 <= _blur_y_s0_x_x_forall && _blur_y_s0_x_x_forall < 512 && 0 <= _blur_y_s0_x_xi_forall && _blur_y_s0_x_xi_forall < 2; Perm({:_blur_y[(_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1024 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall]:}, 1\1));
     loop_invariant (\forall int _blur_y_s0_x_x_forall, int _blur_y_s0_x_xi_forall; 0 <= _blur_y_s0_x_x_forall && _blur_y_s0_x_x_forall < _blur_y_s0_x_x && 0 <= _blur_y_s0_x_xi_forall && _blur_y_s0_x_xi_forall < 2; {:_blur_y[(_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1024 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall]:} == \euclidean_div(\euclidean_div(pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 1) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 2), 3) + \euclidean_div(pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 1026) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 1027) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 1028), 3) + \euclidean_div(pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 2052) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 2053) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1026 + _blur_y_s0_x_x_forall*2 + _blur_y_s0_x_xi_forall + 2054), 3), 3));
    @*/
    for (int _blur_y_s0_x_x = 0; _blur_y_s0_x_x < 0 + 512; _blur_y_s0_x_x++)
    {
     int32_t _t10 = (_blur_y_s0_x_x + _t16);
     int32_t _9 = _blur_x[(_t10 * 2)];
     int32_t _10 = _blur_x[((_t10 * 2) + 1024)];
     int32_t _11 = _blur_x[((_t10 * 2) + 2048)];
     _blur_y[((_blur_y_s0_x_x + _t17) * 2)]= div_eucl((_9 + (_10 + _11)), 3);
     int32_t _t11 = (_blur_y_s0_x_x + _t16);
     int32_t _12 = _blur_x[((_t11 * 2) + 1)];
     int32_t _13 = _blur_x[((_t11 * 2) + 1025)];
     int32_t _14 = _blur_x[((_t11 * 2) + 2049)];
     _blur_y[(((_blur_y_s0_x_x + _t17) * 2) + 1)]= div_eucl((_12 + (_13 + _14)), 3);
    } // for _blur_y_s0_x_x
   } // for _blur_y_s0_y_yi
   free(_blur_x);
  } // alloc _blur_x
