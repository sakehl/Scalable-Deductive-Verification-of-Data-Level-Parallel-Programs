...
@*/
int gemm_0(struct halide_buffer_const_int32_t *_A__buffer, struct halide_buffer_const_int32_t *_B__buffer, struct halide_buffer_const_int32_t *_C__buffer, /*@unique_pointer_field<host, 1>@*/ struct halide_buffer_int32_t *_result_buffer) {
