...
@*/
int hist_3(struct halide_buffer_const_float *_input_buffer, /*@unique_pointer_field<host, 1>@*/ struct halide_buffer_float *_output_buffer) {
 ...
 {
  int64_t _2 = 655360;
  /*@unique<2>@*/ int32_t *_hist_rows = (/*@unique<2>@*/ int32_t  *)malloc(sizeof(/*@unique<2>@*/ int32_t )*_2);
