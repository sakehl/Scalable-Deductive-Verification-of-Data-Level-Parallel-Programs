...
@*/
int hist_2_non_unique(struct halide_buffer_float *_input_buffer, struct halide_buffer_float *_output_buffer) {
 ...
 {
  int64_t _2 = 3932160;
  float *_Y = (float  *)malloc(sizeof(float )*_2);
  //@ assume _Y != NULL;
  // produce Y
  /*@
   loop_invariant 0 <= _Y_s0_y && _Y_s0_y <= 0 + 2560;
   ...
   loop_invariant (\forall* int _Y_s0_y_forall, int _Y_s0_x_forall; 0 <= _Y_s0_y_forall && _Y_s0_y_forall < 2560 && 0 <= _Y_s0_x_forall && _Y_s0_x_forall < 1536; Perm({:_Y[_Y_s0_y_forall*1536 + _Y_s0_x_forall]:}, 1\1));
  @*/
  for (int _Y_s0_y = 0; _Y_s0_y < 0 + 2560; _Y_s0_y++)
  {
   int32_t _t51 = (_Y_s0_y * 1536);
   /*@
    loop_invariant 0 <= _Y_s0_x && _Y_s0_x <= 0 + 1536;
    loop_invariant (\forall* int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; Perm({:_input[(_2*2560 + _1)*1536 + _0]:}, 1\(2*2*2)));
    loop_invariant (\forall int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; {:_input[(_2*2560 + _1)*1536 + _0]:} == pure_input((_2*2560 + _1)*1536 + _0));
    loop_invariant (\forall int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; 0.000000 <= _input[(_2*2560 + _1)*1536 + _0] && _input[(_2*2560 + _1)*1536 + _0] <= 255.000000);
    loop_invariant true;
    loop_invariant (\forall* int _Y_s0_x_forall; 0 <= _Y_s0_x_forall && _Y_s0_x_forall < 1536; Perm({:_Y[_Y_s0_y*1536 + _Y_s0_x_forall]:}, 1\1));
   @*/
   for (int _Y_s0_x = 0; _Y_s0_x < 0 + 1536; _Y_s0_x++)
   {
    int32_t _t46 = (_Y_s0_x + _t51);
    float _3 = _input[(_t46 + 7864320)];
    float _4 = _input[_t46];
    float _5 = _input[(_t46 + 3932160)];
    _Y[_t46]= ((_3 * 0.114000) + ((_4 * 0.299000) + (_5 * 0.587000)));
   } // for _Y_s0_x
  } // for _Y_s0_y
  {
   int32_t _hist[256];
   ...
   /*@
    ...
    loop_invariant (\forall* int _x, int _y; 0 <= _x && _x < 1536 && 0 <= _y && _y < 2560; Perm({:_Y[_y*1536 + _x]:}, 1\(2*2*2)));
    loop_invariant (\forall* int _hist_s1_x_forall; 0 <= _hist_s1_x_forall && _hist_s1_x_forall < 256; Perm({:_hist[_hist_s1_x_forall]:}, 1\1));
    loop_invariant (\forall int _hist_s1_x_forall; _hist_s1_x <= _hist_s1_x_forall && _hist_s1_x_forall < 256; 0 <= {:_hist[_hist_s1_x_forall]:} && _hist[_hist_s1_x_forall] <= 0);
    loop_invariant (\forall int _hist_s1_x_forall; 0 <= _hist_s1_x_forall && _hist_s1_x_forall < _hist_s1_x; 0 <= {:_hist[_hist_s1_x_forall]:} && _hist[_hist_s1_x_forall] <= 3932160);
   @*/
   for (int _hist_s1_x = 0; _hist_s1_x < 0 + 256; _hist_s1_x++)
   {
    /*@
     ...
     loop_invariant true;
     loop_invariant (\forall* int _x, int _y; 0 <= _x && _x < 1536 && 0 <= _y && _y < 2560; Perm({:_Y[_y*1536 + _x]:}, 1\(2*2*2*2)));
    ...
    {
     {
      ...
      int32_t _t52 = (_hist_s1_r22__x * 1536);
      /*@
       loop_invariant 0 <= _hist_rows_s1_r15__x && _hist_rows_s1_r15__x <= 0 + 1536;
       loop_invariant true;
       loop_invariant (\forall* int _x, int _y; 0 <= _x && _x < 1536 && 0 <= _y && _y < 2560; Perm({:_Y[_y*1536 + _x]:}, 1\(2*2*2*2*2*2*2)));
      ...
      {
       float _6 = _Y[(_hist_rows_s1_r15__x + _t52)];
       float _7 = _6<255.000000 ? _6 : 255.000000;
       float _8 = _7>0.000000 ? _7 : 0.000000;
       int32_t _9 = (int32_t)(_8);
       int32_t _t40 = _9;
       int32_t _10 = _hist_rows[_t40];
       _hist_rows[_t40]= (_10 + 1);
      } // for _hist_rows_s1_r15__x
      // consume hist_rows
      int32_t _11 = _hist[_hist_s1_x];
      int32_t _12 = _hist_rows[_hist_s1_x];
      _hist[_hist_s1_x]= (_11 + _12);
     } // alloc _hist_rows
    } // for _hist_s1_r22__x
   } // for _hist_s1_x
   {
    int64_t _13 = 3932160;
    float *_equalize = (float  *)malloc(sizeof(float )*_13);
    //@ assume _equalize != NULL;
    // produce equalize
    // consume hist
    // consume Y
    /*@
     loop_invariant 0 <= _equalize_s0_y && _equalize_s0_y <= 0 + 2560;
     loop_invariant (\forall* int _x, int _y; 0 <= _x && _x < 1536 && 0 <= _y && _y < 2560; Perm({:_Y[_y*1536 + _x]:}, 1\(2*2*2)));
     ...
     loop_invariant (\forall* int _equalize_s0_y_forall, int _equalize_s0_x_forall; 0 <= _equalize_s0_y_forall && _equalize_s0_y_forall < 2560 && 0 <= _equalize_s0_x_forall && _equalize_s0_x_forall < 1536; Perm({:_equalize[_equalize_s0_y_forall*1536 + _equalize_s0_x_forall]:}, 1\1));
    @*/
    for (int _equalize_s0_y = 0; _equalize_s0_y < 0 + 2560; _equalize_s0_y++)
    {
     int32_t _t53 = (_equalize_s0_y * 1536);
     /*@
      loop_invariant 0 <= _equalize_s0_x && _equalize_s0_x <= 0 + 1536;
      loop_invariant true;
      loop_invariant (\forall* int _x, int _y; 0 <= _x && _x < 1536 && 0 <= _y && _y < 2560; Perm({:_Y[_y*1536 + _x]:}, 1\(2*2*2*2)));
      loop_invariant (\forall* int _x; 0 <= _x && _x < 256; Perm({:_hist[_x]:}, 1\(2*2*2*2)));
      loop_invariant (\forall int _hist_s1_x; 0 <= _hist_s1_x && _hist_s1_x <= 255; 0 <= {:_hist[_hist_s1_x]:} && _hist[_hist_s1_x] <= 3932160);
      loop_invariant (\forall* int _equalize_s0_x_forall; 0 <= _equalize_s0_x_forall && _equalize_s0_x_forall < 1536; Perm({:_equalize[_equalize_s0_y*1536 + _equalize_s0_x_forall]:}, 1\1));
     @*/
     ...
     {
      {
       ...
       /*@
        ...
        loop_invariant (\forall* int _x; 0 <= _x && _x < 256; Perm({:_hist[_x]:}, 1\(2*2*2*2*2*2)));
        loop_invariant (\forall int _hist_s1_x; 0 <= _hist_s1_x && _hist_s1_x <= 255; 0 <= {:_hist[_hist_s1_x]:} && _hist[_hist_s1_x] <= 3932160);
       ...
       {
        int32_t _15 = _cdf[(_cdf_s1_r29__x + -1)];
        int32_t _16 = _hist[_cdf_s1_r29__x];
        _cdf[_cdf_s1_r29__x]= (_15 + _16);
       } // for _cdf_s1_r29__x
       // consume cdf
       int32_t _t47 = (_equalize_s0_x + _t53);
       float _17 = _Y[_t47];
       float _18 = _17<255.000000 ? _17 : 255.000000;
    ...
    /*@
     ...
     context true;
     context (\forall* int _x, int _y; 0 <= _x && _x < 1536 && 0 <= _y && _y < 2560; Perm({:_Y[_y*1536 + _x]:}, 1\(2*2*2560*2)));
     context (\forall* int _x, int _y; 0 <= _x && _x < 1536 && 0 <= _y && _y < 2560; Perm({:_equalize[_y*1536 + _x]:}, 1\(2*2*2560*2)));
    ...
    @*/
    {
     int32_t _t54 = (_output_s0_y * 1536);
     /*@
      ...
      loop_invariant (\forall int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; 0.000000 <= _input[(_2*2560 + _1)*1536 + _0] && _input[(_2*2560 + _1)*1536 + _0] <= 255.000000);
      loop_invariant true;
      loop_invariant (\forall* int _x, int _y; 0 <= _x && _x < 1536 && 0 <= _y && _y < 2560; Perm({:_Y[_y*1536 + _x]:}, 1\(2*2*2560*2*2)));
      loop_invariant (\forall* int _x, int _y; 0 <= _x && _x < 1536 && 0 <= _y && _y < 2560; Perm({:_equalize[_y*1536 + _x]:}, 1\(2*2*2560*2*2)));
     ...
     {
      int32_t _t48 = (_output_s0_x + _t54);
      float _26 = _equalize[_t48];
      float _27 = _input[_t48];
      float _28 = _Y[_t48];
      float _29 = (_26 + ((_27 - _28) * 0.998200))<255.000000 ? (_26 + ((_27 - _28) * 0.998200)) : 255.000000;
      float _30 = _29>0.000000 ? _29 : 0.000000;
      _output[_t48]= _30;
      float _31 = _Y[(_output_s0_x + _t54)];
      float _t44 = _31;
      int32_t _t49 = (_output_s0_x + _t54);
      float _32 = _equalize[_t49];
      float _33 = _input[(_t49 + 7864320)];
      float _34 = _input[_t49];
      float _35 = ((_32 - ((_33 - _t44) * 0.193452)) - ((_34 - _t44) * 0.506943))<255.000000 ? ((_32 - ((_33 - _t44) * 0.193452)) - ((_34 - _t44) * 0.506943)) : 255.000000;
      float _36 = _35>0.000000 ? _35 : 0.000000;
      _output[(_t49 + 3932160)]= _36;
      int32_t _t50 = (_output_s0_x + _t54);
      float _37 = _equalize[_t50];
      float _38 = _input[(_t50 + 7864320)];
      float _39 = _Y[_t50];
      float _40 = ((_37 + ((_38 - _39) * 0.995460)) * 0.001000)<255.000000 ? ((_37 + ((_38 - _39) * 0.995460)) * 0.001000) : 255.000000;
      float _41 = _40>0.000000 ? _40 : 0.000000;
      _output[(_t50 + 7864320)]= _41;
     } // for _output_s0_x
    } // for _output_s0_y
    free(_Y);
    free(_equalize);
