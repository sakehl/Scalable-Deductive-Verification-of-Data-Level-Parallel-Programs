...
@*/
int blur_3(struct halide_buffer_const_int32_t *_inp_buffer, /*@unique_pointer_field<host, 1>@*/ struct halide_buffer_int32_t *_blur_y_buffer) {
 ...
 @*/
 {
  {
   int64_t _2 = 10240;
   /*@unique<2>@*/ int32_t *_blur_x = (/*@unique<2>@*/ int32_t  *)malloc(sizeof(/*@unique<2>@*/ int32_t )*_2);
   //@ assume _blur_x != NULL;
