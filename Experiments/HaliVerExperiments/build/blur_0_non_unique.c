...
@*/
int blur_0_non_unique(struct halide_buffer_int32_t *_inp_buffer, struct halide_buffer_int32_t *_blur_y_buffer) {
 ...
 /*@
  ...
  loop_invariant (\forall* int _0, int _1; 0 <= _0 && _0 < 1026 && 0 <= _1 && _1 < 1026; Perm({:_inp[_1*1026 + _0]:}, 1\(2*2)));
  ...
  loop_invariant (\forall int _blur_y_s0_y_forall, int _blur_y_s0_x_forall; 0 <= _blur_y_s0_y_forall && _blur_y_s0_y_forall < _blur_y_s0_y && 0 <= _blur_y_s0_x_forall && _blur_y_s0_x_forall < 1024; {:_blur_y[_blur_y_s0_y_forall*1024 + _blur_y_s0_x_forall]:} == \euclidean_div(\euclidean_div(pure_inp(_blur_y_s0_y_forall*1026 + _blur_y_s0_x_forall) + pure_inp(_blur_y_s0_y_forall*1026 + _blur_y_s0_x_forall + 1) + pure_inp(_blur_y_s0_y_forall*1026 + _blur_y_s0_x_forall + 2), 3) + \euclidean_div(pure_inp(_blur_y_s0_y_forall*1026 + _blur_y_s0_x_forall + 1026) + pure_inp(_blur_y_s0_y_forall*1026 + _blur_y_s0_x_forall + 1027) + pure_inp(_blur_y_s0_y_forall*1026 + _blur_y_s0_x_forall + 1028), 3) + \euclidean_div(pure_inp(_blur_y_s0_y_forall*1026 + _blur_y_s0_x_forall + 2052) + pure_inp(_blur_y_s0_y_forall*1026 + _blur_y_s0_x_forall + 2053) + pure_inp(_blur_y_s0_y_forall*1026 + _blur_y_s0_x_forall + 2054), 3), 3));
 @*/
 for (int _blur_y_s0_y = 0; _blur_y_s0_y < 0 + 1024; _blur_y_s0_y++)
 {
  ...
  /*@
   ...
   loop_invariant (\forall* int _0, int _1; 0 <= _0 && _0 < 1026 && 0 <= _1 && _1 < 1026; Perm({:_inp[_1*1026 + _0]:}, 1\(2*2*2)));
   loop_invariant (\forall int _0, int _1; 0 <= _0 && _0 < 1026 && 0 <= _1 && _1 < 1026; {:_inp[_1*1026 + _0]:} == pure_inp(_1*1026 + _0));
   ...
   loop_invariant (\forall int _blur_y_s0_x_forall; 0 <= _blur_y_s0_x_forall && _blur_y_s0_x_forall < _blur_y_s0_x; {:_blur_y[_blur_y_s0_y*1024 + _blur_y_s0_x_forall]:} == \euclidean_div(\euclidean_div(pure_inp(_blur_y_s0_y*1026 + _blur_y_s0_x_forall) + pure_inp(_blur_y_s0_y*1026 + _blur_y_s0_x_forall + 1) + pure_inp(_blur_y_s0_y*1026 + _blur_y_s0_x_forall + 2), 3) + \euclidean_div(pure_inp(_blur_y_s0_y*1026 + _blur_y_s0_x_forall + 1026) + pure_inp(_blur_y_s0_y*1026 + _blur_y_s0_x_forall + 1027) + pure_inp(_blur_y_s0_y*1026 + _blur_y_s0_x_forall + 1028), 3) + \euclidean_div(pure_inp(_blur_y_s0_y*1026 + _blur_y_s0_x_forall + 2052) + pure_inp(_blur_y_s0_y*1026 + _blur_y_s0_x_forall + 2053) + pure_inp(_blur_y_s0_y*1026 + _blur_y_s0_x_forall + 2054), 3), 3));
  @*/
