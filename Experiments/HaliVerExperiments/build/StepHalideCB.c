...
/*@
 ...
 context _next_solutions__1_buffer->shape.dim[2].min == 0 && _next_solutions__1_buffer->shape.dim[2].extent == 8 && _next_solutions__1_buffer->shape.dim[2].stride == 1*2*2;
 context _next_solutions__1_buffer->shape.dim[3].min == 0 && _next_solutions__1_buffer->shape.dim[3].extent == 50 && _next_solutions__1_buffer->shape.dim[3].stride == 1*2*2*8;
 context (\forall* int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 0 + 2 && 0 <= _1 && _1 < 0 + 2 && 0 <= _2 && _2 < 0 + 8 && 0 <= _3 && _3 < 0 + 50; Perm({:_next_solutions__1_buffer->host[_3*32 + _2*4 + _1*2 + _0]:}, 1\1));
 context_everywhere true;
@*/
int StepHalideCB(bool _phase_only, double _step_size, struct halide_buffer_const_double *_sol__buffer, struct halide_buffer_const_double *_next_sol__buffer, /*@unique_pointer_field<host, 1>@*/ struct halide_buffer_double *_next_solutions__1_buffer) {
 ...
 if (_phase_only)
 {
  /*@
   ...
   loop_invariant (\forall* int _next_solutions__1_s0_a_forall, int _next_solutions__1_s0_si_forall, int _next_solutions__1_s0_i_forall, int _next_solutions__1_s0_c_forall; 0 <= _next_solutions__1_s0_a_forall && _next_solutions__1_s0_a_forall < 50 && 0 <= _next_solutions__1_s0_si_forall && _next_solutions__1_s0_si_forall < 8 && 0 <= _next_solutions__1_s0_i_forall && _next_solutions__1_s0_i_forall < 2 && 0 <= _next_solutions__1_s0_c_forall && _next_solutions__1_s0_c_forall < 2; Perm({:_next_solutions__1[((_next_solutions__1_s0_a_forall*8 + _next_solutions__1_s0_si_forall)*2 + _next_solutions__1_s0_i_forall)*2 + _next_solutions__1_s0_c_forall]:}, 1\1));
  @*/
  for (int _next_solutions__1_s0_a = 0; _next_solutions__1_s0_a < 0 + 50; _next_solutions__1_s0_a++)
  {
   int32_t _t8355 = (_next_solutions__1_s0_a * 16);
   /*@
    loop_invariant 0 <= _next_solutions__1_s0_si && _next_solutions__1_s0_si <= 0 + 8;
    loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < 8 && 0 <= _3 && _3 < 50; {:_next_sol_[((_3*8 + _2)*2 + _1)*2 + _0]:} == pure_next_sol_(((_3*8 + _2)*2 + _1)*2 + _0));
    loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < 8 && 0 <= _3 && _3 < 50; {:_sol_[((_3*8 + _2)*2 + _1)*2 + _0]:} == pure_sol_(((_3*8 + _2)*2 + _1)*2 + _0));
    loop_invariant true;
    loop_invariant (\forall* int _next_solutions__1_s0_si_forall, int _next_solutions__1_s0_i_forall, int _next_solutions__1_s0_c_forall; 0 <= _next_solutions__1_s0_si_forall && _next_solutions__1_s0_si_forall < 8 && 0 <= _next_solutions__1_s0_i_forall && _next_solutions__1_s0_i_forall < 2 && 0 <= _next_solutions__1_s0_c_forall && _next_solutions__1_s0_c_forall < 2; Perm({:_next_solutions__1[_next_solutions__1_s0_a*32 + (_next_solutions__1_s0_si_forall*2 + _next_solutions__1_s0_i_forall)*2 + _next_solutions__1_s0_c_forall]:}, 1\1));
   @*/
   for (int _next_solutions__1_s0_si = 0; _next_solutions__1_s0_si < 0 + 8; _next_solutions__1_s0_si++)
   {
    int32_t _t8356 = ((_next_solutions__1_s0_si * 2) + _t8355);
    /*@
     loop_invariant 0 <= _next_solutions__1_s0_i && _next_solutions__1_s0_i <= 0 + 2;
     loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < 8 && 0 <= _3 && _3 < 50; {:_next_sol_[((_3*8 + _2)*2 + _1)*2 + _0]:} == pure_next_sol_(((_3*8 + _2)*2 + _1)*2 + _0));
     loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < 8 && 0 <= _3 && _3 < 50; {:_sol_[((_3*8 + _2)*2 + _1)*2 + _0]:} == pure_sol_(((_3*8 + _2)*2 + _1)*2 + _0));
     loop_invariant true && true;
     loop_invariant (\forall* int _next_solutions__1_s0_i_forall, int _next_solutions__1_s0_c_forall; 0 <= _next_solutions__1_s0_i_forall && _next_solutions__1_s0_i_forall < 2 && 0 <= _next_solutions__1_s0_c_forall && _next_solutions__1_s0_c_forall < 2; Perm({:_next_solutions__1[_next_solutions__1_s0_si*4 + _next_solutions__1_s0_a*32 + _next_solutions__1_s0_i_forall*2 + _next_solutions__1_s0_c_forall]:}, 1\1));
    @*/
    ...
    {
     {
      ...
      // produce distance
      int32_t _t8348 = (_next_solutions__1_s0_i + _t8356);
      double _1202 = _sol_[((_t8348 * 2) + 1)];
      double _1203 = _sol_[(_t8348 * 2)];
      double _1204 = _next_sol_[((_t8348 * 2) + 1)];
      double _1205 = _next_sol_[(_t8348 * 2)];
      _distance[0]= (atan2_f64(_1202, _1203) - atan2_f64(_1204, _1205));
      double _1206 = _distance[0];
      double _t8349 = _1206;
      _distance[0]= (((3.141593 < _t8349) ? -6.283185 : 6.283185) + _t8349);
      // consume distance
      int32_t _t8350 = (_next_solutions__1_s0_i + _t8356);
      double _1207 = _sol_[((_t8350 * 2) + 1)];
      double _1208 = _sol_[(_t8350 * 2)];
      double _1209 = _distance[0];
      _next_solutions__1[(_t8350 * 2)]= cos_f64((atan2_f64(_1207, _1208) + (_1209 * _step_size)));
     } // alloc _distance
     {
      /*@unique<3>@*/ double _distance[1];
      // produce distance
      int32_t _t8351 = (_next_solutions__1_s0_i + _t8356);
      double _1210 = _sol_[((_t8351 * 2) + 1)];
      double _1211 = _sol_[(_t8351 * 2)];
      double _1212 = _next_sol_[((_t8351 * 2) + 1)];
      double _1213 = _next_sol_[(_t8351 * 2)];
      _distance[0]= (atan2_f64(_1210, _1211) - atan2_f64(_1212, _1213));
      double _1214 = _distance[0];
      double _t8352 = _1214;
      _distance[0]= (((3.141593 < _t8352) ? -6.283185 : 6.283185) + _t8352);
      // consume distance
      int32_t _t8353 = (_next_solutions__1_s0_i + _t8356);
      double _1215 = _sol_[((_t8353 * 2) + 1)];
      double _1216 = _sol_[(_t8353 * 2)];
      double _1217 = _distance[0];
      _next_solutions__1[((_t8353 * 2) + 1)]= sin_f64((atan2_f64(_1215, _1216) + (_1217 * _step_size)));
     } // alloc _distance
 ...
 else
 {
  ...
  for (int _next_solutions__1_s0_a = 0; _next_solutions__1_s0_a < 0 + 50; _next_solutions__1_s0_a++)
  {
   int32_t _t8360 = (_next_solutions__1_s0_a * 32);
   int32_t _t8358 = (_next_solutions__1_s0_a * 16);
   /*@
    loop_invariant 0 <= _next_solutions__1_s0_si && _next_solutions__1_s0_si <= 0 + 8;
    loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < 8 && 0 <= _3 && _3 < 50; {:_next_sol_[((_3*8 + _2)*2 + _1)*2 + _0]:} == pure_next_sol_(((_3*8 + _2)*2 + _1)*2 + _0));
    loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < 8 && 0 <= _3 && _3 < 50; {:_sol_[((_3*8 + _2)*2 + _1)*2 + _0]:} == pure_sol_(((_3*8 + _2)*2 + _1)*2 + _0));
   ...
   for (int _next_solutions__1_s0_si = 0; _next_solutions__1_s0_si < 0 + 8; _next_solutions__1_s0_si++)
   {
    int32_t _t8363 = ((_next_solutions__1_s0_si * 4) + _t8360);
    int32_t _t8361 = ((_next_solutions__1_s0_si * 2) + _t8358);
    /*@
     loop_invariant 0 <= _next_solutions__1_s0_i && _next_solutions__1_s0_i <= 0 + 2;
     loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < 8 && 0 <= _3 && _3 < 50; {:_next_sol_[((_3*8 + _2)*2 + _1)*2 + _0]:} == pure_next_sol_(((_3*8 + _2)*2 + _1)*2 + _0));
     loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < 8 && 0 <= _3 && _3 < 50; {:_sol_[((_3*8 + _2)*2 + _1)*2 + _0]:} == pure_sol_(((_3*8 + _2)*2 + _1)*2 + _0));
    ...
    for (int _next_solutions__1_s0_i = 0; _next_solutions__1_s0_i < 0 + 2; _next_solutions__1_s0_i++)
    {
     int32_t _t8366 = ((_next_solutions__1_s0_i * 2) + _t8363);
     int32_t _t8364 = (_next_solutions__1_s0_i + _t8361);
     /*@
      loop_invariant 0 <= _next_solutions__1_s0_c && _next_solutions__1_s0_c <= 0 + 2;
      loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < 8 && 0 <= _3 && _3 < 50; {:_next_sol_[((_3*8 + _2)*2 + _1)*2 + _0]:} == pure_next_sol_(((_3*8 + _2)*2 + _1)*2 + _0));
      loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < 8 && 0 <= _3 && _3 < 50; {:_sol_[((_3*8 + _2)*2 + _1)*2 + _0]:} == pure_sol_(((_3*8 + _2)*2 + _1)*2 + _0));
      loop_invariant true && true && true;
      loop_invariant (\forall* int _next_solutions__1_s0_c_forall; 0 <= _next_solutions__1_s0_c_forall && _next_solutions__1_s0_c_forall < 2; Perm({:_next_solutions__1[_next_solutions__1_s0_i*2 + _next_solutions__1_s0_si*4 + _next_solutions__1_s0_a*32 + _next_solutions__1_s0_c_forall]:}, 1\1));
     @*/
     for (int _next_solutions__1_s0_c = 0; _next_solutions__1_s0_c < 0 + 2; _next_solutions__1_s0_c++)
     {
      // consume distance
      double _1218 = _sol_[(_t8364 * 2)];
      double _1219 = _next_sol_[(_t8364 * 2)];
      double _1220 = _sol_[((_t8364 * 2) + 1)];
      double _1221 = _next_sol_[((_t8364 * 2) + 1)];
      _next_solutions__1[(_next_solutions__1_s0_c + _t8366)]= ((_next_solutions__1_s0_c == 0) ? ((_1218 * (1.000000 - _step_size)) + (_1219 * _step_size)) : ((_next_solutions__1_s0_c == 1) ? ((_1220 * (1.000000 - _step_size)) + (_1221 * _step_size)) : ((_1220 * (1.000000 - _step_size)) + (_1221 * _step_size))));
