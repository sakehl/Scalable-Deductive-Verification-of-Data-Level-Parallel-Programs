...
/*@
 context buffer_int32_t(_inp_buffer, 1\2, 2);
 ...
 context _blur_y_buffer->host != _inp_buffer->host;
 ...
 context (\forall* int _0, int _1; 0 <= _0 && _0 < 0 + 1026 && 0 <= _1 && _1 < 0 + 1026; Perm({:_inp_buffer->host[_1*1026 + _0]:}, 1\2));
 ...
 ensures (\forall int _0, int _1; 0 <= _0 && _0 < 0 + 1024 && 0 <= _1 && _1 < 0 + 1024; {:_blur_y_buffer->host[_1*1024 + _0]:} == \euclidean_div(\euclidean_div(_inp_buffer->host[_1*1026 + _0 + 1027] + _inp_buffer->host[_1*1026 + _0 + 1028] + _inp_buffer->host[_1*1026 + _0 + 1026], 3) + \euclidean_div(_inp_buffer->host[_1*1026 + _0 + 2053] + _inp_buffer->host[_1*1026 + _0 + 2054] + _inp_buffer->host[_1*1026 + _0 + 2052], 3) + \euclidean_div(_inp_buffer->host[_1*1026 + _0 + 1] + _inp_buffer->host[_1*1026 + _0 + 2] + _inp_buffer->host[_1*1026 + _0], 3), 3));
@*/
int blur_2_non_unique(struct halide_buffer_int32_t *_inp_buffer, struct halide_buffer_int32_t *_blur_y_buffer) {
 int32_t* _blur_y = _halide_buffer_get_host_int32_t(_blur_y_buffer);
 ...
 for (int _blur_y_s0_y_y = 0; _blur_y_s0_y_y < 0 + 128; _blur_y_s0_y_y++)
 /*@
  context 0 <= _blur_y_s0_y_y && _blur_y_s0_y_y < 0 + 128;
  context (\forall* int _0, int _1; 0 <= _0 && _0 < 1026 && 0 <= _1 && _1 < 1026; Perm({:_inp[_1*1026 + _0]:}, 1\(2*128*2)));
  context (\forall int _0, int _1; 0 <= _0 && _0 < 1026 && 0 <= _1 && _1 < 1026; {:_inp[_1*1026 + _0]:} == pure_inp(_1*1026 + _0));
  context (\forall* int _blur_y_s0_x_x_forall, int _blur_y_s0_y_yi_forall, int _blur_y_s0_x_xi_forall; 0 <= _blur_y_s0_x_x_forall && _blur_y_s0_x_x_forall < 128 && 0 <= _blur_y_s0_y_yi_forall && _blur_y_s0_y_yi_forall < 8 && 0 <= _blur_y_s0_x_xi_forall && _blur_y_s0_x_xi_forall < 8; Perm({:_blur_y[(_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1024 + _blur_y_s0_x_x_forall*8 + _blur_y_s0_x_xi_forall]:}, 1\1));
  ensures (\forall int _blur_y_s0_x_x_forall, int _blur_y_s0_y_yi_forall, int _blur_y_s0_x_xi_forall; 0 <= _blur_y_s0_x_x_forall && _blur_y_s0_x_x_forall < 128 && 0 <= _blur_y_s0_y_yi_forall && _blur_y_s0_y_yi_forall < 8 && 0 <= _blur_y_s0_x_xi_forall && _blur_y_s0_x_xi_forall < 8; {:_blur_y[(_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1024 + _blur_y_s0_x_x_forall*8 + _blur_y_s0_x_xi_forall]:} == \euclidean_div(\euclidean_div(pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*8 + _blur_y_s0_x_xi_forall) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*8 + _blur_y_s0_x_xi_forall + 1) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*8 + _blur_y_s0_x_xi_forall + 2), 3) + \euclidean_div(pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*8 + _blur_y_s0_x_xi_forall + 1026) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*8 + _blur_y_s0_x_xi_forall + 1027) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*8 + _blur_y_s0_x_xi_forall + 1028), 3) + \euclidean_div(pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*8 + _blur_y_s0_x_xi_forall + 2052) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*8 + _blur_y_s0_x_xi_forall + 2053) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_x_forall*8 + _blur_y_s0_x_xi_forall + 2054), 3), 3));
 @*/
 {
  int32_t _t7 = (_blur_y_s0_y_y * 8);
  #pragma omp parallel for
  for (int _blur_y_s0_x_x = 0; _blur_y_s0_x_x < 0 + 128; _blur_y_s0_x_x++)
  /*@
   context 0 <= _blur_y_s0_x_x && _blur_y_s0_x_x < 0 + 128;
   context (\forall* int _0, int _1; 0 <= _0 && _0 < 1026 && 0 <= _1 && _1 < 1026; Perm({:_inp[_1*1026 + _0]:}, 1\(2*128*2*128*2)));
   context (\forall int _0, int _1; 0 <= _0 && _0 < 1026 && 0 <= _1 && _1 < 1026; {:_inp[_1*1026 + _0]:} == pure_inp(_1*1026 + _0));
   context (\forall* int _blur_y_s0_y_yi_forall, int _blur_y_s0_x_xi_forall; 0 <= _blur_y_s0_y_yi_forall && _blur_y_s0_y_yi_forall < 8 && 0 <= _blur_y_s0_x_xi_forall && _blur_y_s0_x_xi_forall < 8; Perm({:_blur_y[_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1024 + _blur_y_s0_x_xi_forall]:}, 1\1));
   ensures (\forall int _blur_y_s0_y_yi_forall, int _blur_y_s0_x_xi_forall; 0 <= _blur_y_s0_y_yi_forall && _blur_y_s0_y_yi_forall < 8 && 0 <= _blur_y_s0_x_xi_forall && _blur_y_s0_x_xi_forall < 8; {:_blur_y[_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1024 + _blur_y_s0_x_xi_forall]:} == \euclidean_div(\euclidean_div(pure_inp(_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_xi_forall) + pure_inp(_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_xi_forall + 1) + pure_inp(_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_xi_forall + 2), 3) + \euclidean_div(pure_inp(_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_xi_forall + 1026) + pure_inp(_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_xi_forall + 1027) + pure_inp(_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_xi_forall + 1028), 3) + \euclidean_div(pure_inp(_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_xi_forall + 2052) + pure_inp(_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_xi_forall + 2053) + pure_inp(_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_xi_forall + 2054), 3), 3));
  @*/
  {
   {
    int32_t _blur_x[80];
    // produce blur_x
    int32_t _t8 = (_blur_y_s0_x_x * 8);
    /*@
     loop_invariant _t7 <= _blur_x_s0_y && _blur_x_s0_y <= _t7 + 10;
     loop_invariant (\forall* int _0, int _1; 0 <= _0 && _0 < 1026 && 0 <= _1 && _1 < 1026; Perm({:_inp[_1*1026 + _0]:}, 1\(2*128*2*128*2*2)));
     loop_invariant (\forall int _0, int _1; 0 <= _0 && _0 < 1026 && 0 <= _1 && _1 < 1026; {:_inp[_1*1026 + _0]:} == pure_inp(_1*1026 + _0));
     loop_invariant (\forall* int _blur_x_s0_y_forall, int _blur_x_s0_x_forall; _blur_y_s0_y_y*8 <= _blur_x_s0_y_forall && _blur_x_s0_y_forall < _blur_y_s0_y_y*8 + 10 && _blur_y_s0_x_x*8 <= _blur_x_s0_x_forall && _blur_x_s0_x_forall < _blur_y_s0_x_x*8 + 8; Perm({:_blur_x[(_blur_x_s0_y_forall - _blur_y_s0_y_y*8)*8 + _blur_x_s0_x_forall - _blur_y_s0_x_x*8]:}, 1\1));
     loop_invariant (\forall int _blur_x_s0_y_forall, int _blur_x_s0_x_forall; _blur_y_s0_y_y*8 <= _blur_x_s0_y_forall && _blur_x_s0_y_forall < _blur_x_s0_y && _blur_y_s0_x_x*8 <= _blur_x_s0_x_forall && _blur_x_s0_x_forall < _blur_y_s0_x_x*8 + 8; {:_blur_x[(_blur_x_s0_y_forall - _blur_y_s0_y_y*8)*8 + _blur_x_s0_x_forall - _blur_y_s0_x_x*8]:} == \euclidean_div(pure_inp(_blur_x_s0_y_forall*1026 + _blur_x_s0_x_forall) + pure_inp(_blur_x_s0_y_forall*1026 + _blur_x_s0_x_forall + 1) + pure_inp(_blur_x_s0_y_forall*1026 + _blur_x_s0_x_forall + 2), 3));
    @*/
    for (int _blur_x_s0_y = _t7; _blur_x_s0_y < _t7 + 10; _blur_x_s0_y++)
    {
     int32_t _t9 = (_blur_x_s0_y * 1026);
     int32_t _t10 = (((_blur_x_s0_y - _t7) * 8) - _t8);
     /*@
      loop_invariant _t8 <= _blur_x_s0_x && _blur_x_s0_x <= _t8 + 8;
      loop_invariant (\forall* int _0, int _1; 0 <= _0 && _0 < 1026 && 0 <= _1 && _1 < 1026; Perm({:_inp[_1*1026 + _0]:}, 1\(2*128*2*128*2*2*2)));
      loop_invariant (\forall int _0, int _1; 0 <= _0 && _0 < 1026 && 0 <= _1 && _1 < 1026; {:_inp[_1*1026 + _0]:} == pure_inp(_1*1026 + _0));
      loop_invariant true && true;
      loop_invariant (\forall* int _blur_x_s0_x_forall; _blur_y_s0_x_x*8 <= _blur_x_s0_x_forall && _blur_x_s0_x_forall < _blur_y_s0_x_x*8 + 8; Perm({:_blur_x[(_blur_x_s0_y - _blur_y_s0_y_y*8)*8 + (_blur_x_s0_x_forall - _blur_y_s0_x_x*8)]:}, 1\1));
      loop_invariant (\forall int _blur_x_s0_x_forall; _blur_y_s0_x_x*8 <= _blur_x_s0_x_forall && _blur_x_s0_x_forall < _blur_x_s0_x; {:_blur_x[(_blur_x_s0_y - _blur_y_s0_y_y*8)*8 + (_blur_x_s0_x_forall - _blur_y_s0_x_x*8)]:} == \euclidean_div(pure_inp(_blur_x_s0_y*1026 + _blur_x_s0_x_forall) + pure_inp(_blur_x_s0_y*1026 + _blur_x_s0_x_forall + 1) + pure_inp(_blur_x_s0_y*1026 + _blur_x_s0_x_forall + 2), 3));
     @*/
     for (int _blur_x_s0_x = _t8; _blur_x_s0_x < _t8 + 8; _blur_x_s0_x++)
     {
      int32_t _t5 = (_blur_x_s0_x + _t9);
      int32_t _2 = _inp[_t5];
      int32_t _3 = _inp[(_t5 + 1)];
      int32_t _4 = _inp[(_t5 + 2)];
      _blur_x[(_blur_x_s0_x + _t10)]= div_eucl((_2 + (_3 + _4)), 3);
     } // for _blur_x_s0_x
    } // for _blur_x_s0_y
    // consume blur_x
    int32_t _t11 = (_blur_y_s0_x_x * 8);
    /*@
     loop_invariant 0 <= _blur_y_s0_y_yi && _blur_y_s0_y_yi <= 0 + 8;
     loop_invariant (\forall* int _x, int _y; _blur_y_s0_x_x*8 <= _x && _x < _blur_y_s0_x_x*8 + 8 && _blur_y_s0_y_y*8 <= _y && _y < _blur_y_s0_y_y*8 + 10; Perm({:_blur_x[(_y - _blur_y_s0_y_y*8)*8 + _x - _blur_y_s0_x_x*8]:}, 1\(2*2)));
     loop_invariant (\forall int _blur_x_s0_x, int _blur_x_s0_y; _blur_y_s0_x_x*8 <= _blur_x_s0_x && _blur_x_s0_x <= _blur_y_s0_x_x*8 + 7 && _blur_y_s0_y_y*8 <= _blur_x_s0_y && _blur_x_s0_y <= _blur_y_s0_y_y*8 + 9; {:_blur_x[(_blur_x_s0_y - _blur_y_s0_y_y*8)*8 + _blur_x_s0_x - _blur_y_s0_x_x*8]:} == \euclidean_div(pure_inp(_blur_x_s0_y*1026 + _blur_x_s0_x) + pure_inp(_blur_x_s0_y*1026 + _blur_x_s0_x + 1) + pure_inp(_blur_x_s0_y*1026 + _blur_x_s0_x + 2), 3));
     loop_invariant (\forall* int _blur_y_s0_y_yi_forall, int _blur_y_s0_x_xi_forall; 0 <= _blur_y_s0_y_yi_forall && _blur_y_s0_y_yi_forall < 8 && 0 <= _blur_y_s0_x_xi_forall && _blur_y_s0_x_xi_forall < 8; Perm({:_blur_y[_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1024 + _blur_y_s0_x_xi_forall]:}, 1\1));
     loop_invariant (\forall int _blur_y_s0_y_yi_forall, int _blur_y_s0_x_xi_forall; 0 <= _blur_y_s0_y_yi_forall && _blur_y_s0_y_yi_forall < _blur_y_s0_y_yi && 0 <= _blur_y_s0_x_xi_forall && _blur_y_s0_x_xi_forall < 8; {:_blur_y[_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1024 + _blur_y_s0_x_xi_forall]:} == \euclidean_div(\euclidean_div(pure_inp(_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_xi_forall) + pure_inp(_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_xi_forall + 1) + pure_inp(_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_xi_forall + 2), 3) + \euclidean_div(pure_inp(_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_xi_forall + 1026) + pure_inp(_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_xi_forall + 1027) + pure_inp(_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_xi_forall + 1028), 3) + \euclidean_div(pure_inp(_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_xi_forall + 2052) + pure_inp(_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_xi_forall + 2053) + pure_inp(_blur_y_s0_x_x*8 + (_blur_y_s0_y_y*8 + _blur_y_s0_y_yi_forall)*1026 + _blur_y_s0_x_xi_forall + 2054), 3), 3));
    @*/
    for (int _blur_y_s0_y_yi = 0; _blur_y_s0_y_yi < 0 + 8; _blur_y_s0_y_yi++)
    {
     int32_t _t12 = (_blur_y_s0_y_yi * 8);
     int32_t _t13 = (((_blur_y_s0_y_yi + _t7) * 1024) + _t11);
     /*@
      loop_invariant 0 <= _blur_y_s0_x_xi && _blur_y_s0_x_xi <= 0 + 8;
      loop_invariant true && true && true && true;
      loop_invariant (\forall* int _x, int _y; _blur_y_s0_x_x*8 <= _x && _x < _blur_y_s0_x_x*8 + 8 && _blur_y_s0_y_y*8 <= _y && _y < _blur_y_s0_y_y*8 + 10; Perm({:_blur_x[(_y - _blur_y_s0_y_y*8)*8 + _x - _blur_y_s0_x_x*8]:}, 1\(2*2*2)));
      loop_invariant (\forall int _blur_x_s0_x, int _blur_x_s0_y; _blur_y_s0_x_x*8 <= _blur_x_s0_x && _blur_x_s0_x <= _blur_y_s0_x_x*8 + 7 && _blur_y_s0_y_y*8 <= _blur_x_s0_y && _blur_x_s0_y <= _blur_y_s0_y_y*8 + 9; {:_blur_x[(_blur_x_s0_y - _blur_y_s0_y_y*8)*8 + _blur_x_s0_x - _blur_y_s0_x_x*8]:} == \euclidean_div(pure_inp(_blur_x_s0_y*1026 + _blur_x_s0_x) + pure_inp(_blur_x_s0_y*1026 + _blur_x_s0_x + 1) + pure_inp(_blur_x_s0_y*1026 + _blur_x_s0_x + 2), 3));
      loop_invariant (\forall* int _blur_y_s0_x_xi_forall; 0 <= _blur_y_s0_x_xi_forall && _blur_y_s0_x_xi_forall < 8; Perm({:_blur_y[(_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1024 + _blur_y_s0_x_x*8 + _blur_y_s0_x_xi_forall]:}, 1\1));
      loop_invariant (\forall int _blur_y_s0_x_xi_forall; 0 <= _blur_y_s0_x_xi_forall && _blur_y_s0_x_xi_forall < _blur_y_s0_x_xi; {:_blur_y[(_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1024 + _blur_y_s0_x_x*8 + _blur_y_s0_x_xi_forall]:} == \euclidean_div(\euclidean_div(pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1026 + _blur_y_s0_x_x*8 + _blur_y_s0_x_xi_forall) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1026 + _blur_y_s0_x_x*8 + _blur_y_s0_x_xi_forall + 1) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1026 + _blur_y_s0_x_x*8 + _blur_y_s0_x_xi_forall + 2), 3) + \euclidean_div(pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1026 + _blur_y_s0_x_x*8 + _blur_y_s0_x_xi_forall + 1026) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1026 + _blur_y_s0_x_x*8 + _blur_y_s0_x_xi_forall + 1027) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1026 + _blur_y_s0_x_x*8 + _blur_y_s0_x_xi_forall + 1028), 3) + \euclidean_div(pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1026 + _blur_y_s0_x_x*8 + _blur_y_s0_x_xi_forall + 2052) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1026 + _blur_y_s0_x_x*8 + _blur_y_s0_x_xi_forall + 2053) + pure_inp((_blur_y_s0_y_y*8 + _blur_y_s0_y_yi)*1026 + _blur_y_s0_x_x*8 + _blur_y_s0_x_xi_forall + 2054), 3), 3));
     @*/
     for (int _blur_y_s0_x_xi = 0; _blur_y_s0_x_xi < 0 + 8; _blur_y_s0_x_xi++)
     {
      int32_t _t6 = (_blur_y_s0_x_xi + _t12);
      int32_t _5 = _blur_x[_t6];
      int32_t _6 = _blur_x[(_t6 + 8)];
      int32_t _7 = _blur_x[(_t6 + 16)];
      _blur_y[(_blur_y_s0_x_xi + _t13)]= div_eucl((_5 + (_6 + _7)), 3);
     } // for _blur_y_s0_x_xi
    } // for _blur_y_s0_y_yi
   } // alloc _blur_x
  } // for _blur_y_s0_x_x
