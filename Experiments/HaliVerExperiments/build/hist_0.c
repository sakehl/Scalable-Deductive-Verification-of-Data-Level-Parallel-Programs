...
@*/
int hist_0(struct halide_buffer_const_float *_input_buffer, /*@unique_pointer_field<host, 1>@*/ struct halide_buffer_float *_output_buffer) {
     ...
     {
      {
       ...
       {
        {
         /*@unique<6>@*/ int32_t _hist_rows[256];
         // produce hist_rows
         /*@
          loop_invariant 0 <= _hist_rows_s0_x && _hist_rows_s0_x <= 0 + 256;
          loop_invariant true;
