...
@*/
int hist_0_non_unique(struct halide_buffer_float *_input_buffer, struct halide_buffer_float *_output_buffer) {
 ...
 /*@
  ...
  loop_invariant (\forall* int _output_s0_c_forall, int _output_s0_y_forall, int _output_s0_x_forall; 0 <= _output_s0_c_forall && _output_s0_c_forall < 3 && 0 <= _output_s0_y_forall && _output_s0_y_forall < 2560 && 0 <= _output_s0_x_forall && _output_s0_x_forall < 1536; Perm({:_output[(_output_s0_c_forall*2560 + _output_s0_y_forall)*1536 + _output_s0_x_forall]:}, 1\1));
  loop_invariant (\forall int _output_s0_c_forall, int _output_s0_y_forall, int _output_s0_x_forall; 0 <= _output_s0_c_forall && _output_s0_c_forall < _output_s0_c && 0 <= _output_s0_y_forall && _output_s0_y_forall < 2560 && 0 <= _output_s0_x_forall && _output_s0_x_forall < 1536; 0.000000 <= {:_output[(_output_s0_c_forall*2560 + _output_s0_y_forall)*1536 + _output_s0_x_forall]:} && _output[(_output_s0_c_forall*2560 + _output_s0_y_forall)*1536 + _output_s0_x_forall] <= 255.000000);
 @*/
 for (int _output_s0_c = 0; _output_s0_c < 0 + 3; _output_s0_c++)
 {
  /*@
   loop_invariant 0 <= _output_s0_y && _output_s0_y <= 0 + 2560;
   loop_invariant (\forall* int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; Perm({:_input[(_2*2560 + _1)*1536 + _0]:}, 1\(2*2*2)));
   loop_invariant (\forall int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; {:_input[(_2*2560 + _1)*1536 + _0]:} == pure_input((_2*2560 + _1)*1536 + _0));
   loop_invariant (\forall int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; 0.000000 <= _input[(_2*2560 + _1)*1536 + _0] && _input[(_2*2560 + _1)*1536 + _0] <= 255.000000);
   loop_invariant true;
   loop_invariant (\forall* int _output_s0_y_forall, int _output_s0_x_forall; 0 <= _output_s0_y_forall && _output_s0_y_forall < 2560 && 0 <= _output_s0_x_forall && _output_s0_x_forall < 1536; Perm({:_output[_output_s0_c*3932160 + _output_s0_y_forall*1536 + _output_s0_x_forall]:}, 1\1));
   loop_invariant (\forall int _output_s0_y_forall, int _output_s0_x_forall; 0 <= _output_s0_y_forall && _output_s0_y_forall < _output_s0_y && 0 <= _output_s0_x_forall && _output_s0_x_forall < 1536; 0.000000 <= {:_output[_output_s0_c*3932160 + _output_s0_y_forall*1536 + _output_s0_x_forall]:} && _output[_output_s0_c*3932160 + _output_s0_y_forall*1536 + _output_s0_x_forall] <= 255.000000);
  @*/
  for (int _output_s0_y = 0; _output_s0_y < 0 + 2560; _output_s0_y++)
  {
   int32_t _t102 = (((_output_s0_c * 2560) + _output_s0_y) * 1536);
   int32_t _t101 = (_output_s0_y * 1536);
   /*@
    loop_invariant 0 <= _output_s0_x && _output_s0_x <= 0 + 1536;
    loop_invariant (\forall* int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; Perm({:_input[(_2*2560 + _1)*1536 + _0]:}, 1\(2*2*2*2)));
    loop_invariant (\forall int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; {:_input[(_2*2560 + _1)*1536 + _0]:} == pure_input((_2*2560 + _1)*1536 + _0));
    loop_invariant (\forall int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; 0.000000 <= _input[(_2*2560 + _1)*1536 + _0] && _input[(_2*2560 + _1)*1536 + _0] <= 255.000000);
    loop_invariant true && true;
    loop_invariant (\forall* int _output_s0_x_forall; 0 <= _output_s0_x_forall && _output_s0_x_forall < 1536; Perm({:_output[_output_s0_y*1536 + _output_s0_c*3932160 + _output_s0_x_forall]:}, 1\1));
    loop_invariant (\forall int _output_s0_x_forall; 0 <= _output_s0_x_forall && _output_s0_x_forall < _output_s0_x; 0.000000 <= {:_output[_output_s0_y*1536 + _output_s0_c*3932160 + _output_s0_x_forall]:} && _output[_output_s0_y*1536 + _output_s0_c*3932160 + _output_s0_x_forall] <= 255.000000);
   @*/
   ...
   {
    {
     ...
     /*@
      ...
      loop_invariant (\forall* int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; Perm({:_input[(_2*2560 + _1)*1536 + _0]:}, 1\(2*2*2*2*2)));
      loop_invariant (\forall int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; {:_input[(_2*2560 + _1)*1536 + _0]:} == pure_input((_2*2560 + _1)*1536 + _0));
      loop_invariant (\forall int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; 0.000000 <= _input[(_2*2560 + _1)*1536 + _0] && _input[(_2*2560 + _1)*1536 + _0] <= 255.000000);
     ...
     {
      {
       ...
       /*@
        ...
        loop_invariant (\forall* int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; Perm({:_input[(_2*2560 + _1)*1536 + _0]:}, 1\(2*2*2*2*2*2)));
        loop_invariant (\forall int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; {:_input[(_2*2560 + _1)*1536 + _0]:} == pure_input((_2*2560 + _1)*1536 + _0));
        loop_invariant (\forall int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; 0.000000 <= _input[(_2*2560 + _1)*1536 + _0] && _input[(_2*2560 + _1)*1536 + _0] <= 255.000000);
        loop_invariant true;
       ...
       {
        {
         ...
         int32_t _t103 = (_hist_s1_r22__x * 1536);
         /*@
          loop_invariant 0 <= _hist_rows_s1_r15__x && _hist_rows_s1_r15__x <= 0 + 1536;
          loop_invariant (\forall* int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; Perm({:_input[(_2*2560 + _1)*1536 + _0]:}, 1\(2*2*2*2*2*2*2)));
          loop_invariant (\forall int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; {:_input[(_2*2560 + _1)*1536 + _0]:} == pure_input((_2*2560 + _1)*1536 + _0));
          loop_invariant (\forall int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; 0.000000 <= _input[(_2*2560 + _1)*1536 + _0] && _input[(_2*2560 + _1)*1536 + _0] <= 255.000000);
          loop_invariant true;
         ...
         {
          float _2 = _input[((_hist_rows_s1_r15__x + _t103) + 7864320)];
          float _3 = _input[(_hist_rows_s1_r15__x + _t103)];
          float _4 = _input[((_hist_rows_s1_r15__x + _t103) + 3932160)];
          ...
          int32_t _t85 = _7;
          int32_t _8 = _hist_rows[_t85];
          _hist_rows[_t85]= (_8 + 1);
       ...
       {
        {
         ...
         int32_t _t104 = (_hist_s1_r22__x * 1536);
         /*@
          loop_invariant 0 <= _hist_rows_s1_r15__x && _hist_rows_s1_r15__x <= 0 + 1536;
          loop_invariant (\forall* int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; Perm({:_input[(_2*2560 + _1)*1536 + _0]:}, 1\(2*2*2*2*2*2*2)));
          loop_invariant (\forall int _0, int _1, int _2; 0 <= _0 && _0 < 1536 && 0 <= _1 && _1 < 2560 && 0 <= _2 && _2 < 3; {:_input[(_2*2560 + _1)*1536 + _0]:} == pure_input((_2*2560 + _1)*1536 + _0));
         ...
         for (int _hist_rows_s1_r15__x = 0; _hist_rows_s1_r15__x < 0 + 1536; _hist_rows_s1_r15__x++)
         {
          float _12 = _input[((_hist_rows_s1_r15__x + _t104) + 7864320)];
          float _13 = _input[(_hist_rows_s1_r15__x + _t104)];
          float _14 = _input[((_hist_rows_s1_r15__x + _t104) + 3932160)];
          ...
          int32_t _t87 = _17;
          int32_t _18 = _hist_rows[_t87];
          _hist_rows[_t87]= (_18 + 1);
         } // for _hist_rows_s1_r15__x
         // consume hist_rows
         int32_t _19 = _hist[0];
     ...
     // consume cdf
     float _23 = _input[((_output_s0_x + _t101) + 7864320)];
     float _t89 = _23;
     float _24 = _input[(_output_s0_x + _t101)];
     float _t90 = _24;
     float _25 = _input[((_output_s0_x + _t101) + 3932160)];
     float _t91 = ((_t89 * 0.114000) + ((_t90 * 0.299000) + (_25 * 0.587000)));
     float _26 = _t91<255.000000 ? _t91 : 255.000000;
     ...
     float _31 = (float)(_30);
     float _t92_s = _31;
     float _32 = _t92_s<3932160.000000 ? _t92_s : 3932160.000000;
     float _33 = _32>0.000000 ? _32 : 0.000000;
     float _t97 = _33;
     float _t98 = (_t90 - _t91);
     float _t99 = (_t89 - _t91);
     float _34 = ((_t97 * 0.000065) + (_t98 * 0.998200))<255.000000 ? ((_t97 * 0.000065) + (_t98 * 0.998200)) : 255.000000;
     float _35 = _34>0.000000 ? _34 : 0.000000;
     float _36 = (((_t97 * 0.000065) - (_t99 * 0.193452)) - (_t98 * 0.506943))<255.000000 ? (((_t97 * 0.000065) - (_t99 * 0.193452)) - (_t98 * 0.506943)) : 255.000000;
     float _37 = _36>0.000000 ? _36 : 0.000000;
     float _38 = (((_t97 * 0.000065) + (_t99 * 0.995460)) * 0.001000)<255.000000 ? (((_t97 * 0.000065) + (_t99 * 0.995460)) * 0.001000) : 255.000000;
     float _39 = _38>0.000000 ? _38 : 0.000000;
     _output[(_output_s0_x + _t102)]= ((_output_s0_c == 0) ? _35 : ((_output_s0_c == 1) ? _37 : ((_output_s0_c == 2) ? _39 : _39)));
    } // alloc _cdf
   } // for _output_s0_x
  } // for _output_s0_y
 } // for _output_s0_c
