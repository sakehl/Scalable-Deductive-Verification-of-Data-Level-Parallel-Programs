...
@*/
int conv_layer_2(struct halide_buffer_const_int32_t *_input_buffer, struct halide_buffer_const_int32_t *_filter_buffer, struct halide_buffer_const_int32_t *_bias_buffer, /*@unique_pointer_field<host, 1>@*/ struct halide_buffer_int32_t *_relu_buffer) {
