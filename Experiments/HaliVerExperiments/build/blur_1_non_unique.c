...
@*/
int blur_1_non_unique(struct halide_buffer_int32_t *_inp_buffer, struct halide_buffer_int32_t *_blur_y_buffer) {
 ...
 for (int _blur_y_s0_x_xy = 0; _blur_y_s0_x_xy < 0 + 1048576; _blur_y_s0_x_xy++)
 /*@
  context 0 <= _blur_y_s0_x_xy && _blur_y_s0_x_xy < 0 + 1048576;
  context (\forall* int _0, int _1; 0 <= _0 && _0 < 1026 && 0 <= _1 && _1 < 1026; Perm({:_inp[_1*1026 + _0]:}, 1\(2*1048576*2)));
  context (\forall int _0, int _1; 0 <= _0 && _0 < 1026 && 0 <= _1 && _1 < 1026; {:_inp[_1*1026 + _0]:} == pure_inp(_1*1026 + _0));
  context true && true && true && true && true && true && true && true && true && true && true && true && true && true && true && true && true;
  context Perm({:_blur_y[_blur_y_s0_x_xy]:}, 1\1);
  ensures {:_blur_y[_blur_y_s0_x_xy]:} == \euclidean_div(\euclidean_div(pure_inp(\euclidean_div(_blur_y_s0_x_xy, 1024)*1026 + \euclidean_mod(_blur_y_s0_x_xy, 1024)) + pure_inp(\euclidean_div(_blur_y_s0_x_xy, 1024)*1026 + \euclidean_mod(_blur_y_s0_x_xy, 1024) + 1) + pure_inp(\euclidean_div(_blur_y_s0_x_xy, 1024)*1026 + \euclidean_mod(_blur_y_s0_x_xy, 1024) + 2), 3) + \euclidean_div(pure_inp(\euclidean_div(_blur_y_s0_x_xy, 1024)*1026 + \euclidean_mod(_blur_y_s0_x_xy, 1024) + 1026) + pure_inp(\euclidean_div(_blur_y_s0_x_xy, 1024)*1026 + \euclidean_mod(_blur_y_s0_x_xy, 1024) + 1027) + pure_inp(\euclidean_div(_blur_y_s0_x_xy, 1024)*1026 + \euclidean_mod(_blur_y_s0_x_xy, 1024) + 1028), 3) + \euclidean_div(pure_inp(\euclidean_div(_blur_y_s0_x_xy, 1024)*1026 + \euclidean_mod(_blur_y_s0_x_xy, 1024) + 2052) + pure_inp(\euclidean_div(_blur_y_s0_x_xy, 1024)*1026 + \euclidean_mod(_blur_y_s0_x_xy, 1024) + 2053) + pure_inp(\euclidean_div(_blur_y_s0_x_xy, 1024)*1026 + \euclidean_mod(_blur_y_s0_x_xy, 1024) + 2054), 3), 3);
 @*/
 {
  int32_t _t6 = ((div_eucl(_blur_y_s0_x_xy, 1024) * 1026) + mod_eucl(_blur_y_s0_x_xy, 1024));
  int32_t _2 = _inp[_t6];
  int32_t _3 = _inp[(_t6 + 1)];
  int32_t _4 = _inp[(_t6 + 2)];
  int32_t _5 = _inp[(_t6 + 1026)];
  int32_t _6 = _inp[(_t6 + 1027)];
  int32_t _7 = _inp[(_t6 + 1028)];
  int32_t _8 = _inp[(_t6 + 2052)];
  int32_t _9 = _inp[(_t6 + 2053)];
  int32_t _10 = _inp[(_t6 + 2054)];
  _blur_y[_blur_y_s0_x_xy]= div_eucl((div_eucl((_2 + (_3 + _4)), 3) + (div_eucl((_5 + (_6 + _7)), 3) + div_eucl((_8 + (_9 + _10)), 3))), 3);
 } // for _blur_y_s0_x_xy
 return 0;
}
