...
@*/
int hist_2(struct halide_buffer_const_float *_input_buffer, /*@unique_pointer_field<host, 1>@*/ struct halide_buffer_float *_output_buffer) {
 ...
 {
  int64_t _2 = 3932160;
  /*@unique<2>@*/ float *_Y = (/*@unique<2>@*/ float  *)malloc(sizeof(/*@unique<2>@*/ float )*_2);
  //@ assume _Y != NULL;
  // produce Y
  /*@
  ...
  } // for _Y_s0_y
  {
   ...
   for (int _hist_s1_x = 0; _hist_s1_x < 0 + 256; _hist_s1_x++)
   {
    ...
    {
     {
      /*@unique<4>@*/ int32_t _hist_rows[256];
      // produce hist_rows
      /*@
   ...
   {
    int64_t _13 = 3932160;
    /*@unique<5>@*/ float *_equalize = (/*@unique<5>@*/ float  *)malloc(sizeof(/*@unique<5>@*/ float )*_13);
