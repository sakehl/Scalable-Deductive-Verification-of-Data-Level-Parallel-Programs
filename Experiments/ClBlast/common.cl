...
// =================================================================================================
...
#ifdef CONST_TYPES
  #define READ_ONLY0 /*@immutable@*/
  #define READ_ONLY1 /*@immutable@*/
  #define READ_ONLY2 /*@immutable@*/
  #define READ_ONLY3 /*@immutable@*/
  #define READ_ONLY4 /*@immutable@*/
#else
  #ifdef UNIQUE_TYPES
  #define READ_ONLY0 /*@unique<0>@*/
  #define READ_ONLY1 /*@unique<1>@*/
  #define READ_ONLY2 /*@unique<2>@*/
  #define READ_ONLY3 /*@unique<3>@*/
  #define READ_ONLY4 /*@unique<4>@*/
  #else
  #define READ_ONLY0
  #define READ_ONLY1
  #define READ_ONLY2
  ...
  #define UNIQUE3 /*@unique<3>@*/
  #define UNIQUE4 /*@unique<4>@*/
  #define UNIQUE5 /*@unique<5>@*/
  #define UNIQUE6 /*@unique<6>@*/
  #define UNIQUE7 /*@unique<7>@*/
  #define UNIQUE8 /*@unique<8>@*/
#else
  #define UNIQUE0
  #define UNIQUE1
  #define UNIQUE2
...
// The scalar multiply-add function
  ...
  #define MultiplyAdd(c,a,b) c.x += MulReal(a,b); c.y += MulImag(a,b)
    ...
    //@ pure real MultiplyAddPure(real c, real a, real b) = c + a*b;
  #endif
#endif
...
//  requires a1 >= n0 * a0;
//  requires a2 >= n1 * a1;
//  ensures 0 <= x0*a0 + x1*a1 + x2*a2 && x0*a0 + x1*a1 + x2*a2 < a0*n0 + a1*n1 + a2*n2;
//  ensures (x0*a0 + x1*a1 + x2*a2) / a2 == x2;
//  ensures (x0*a0 + x1*a1 + x2*a2) % a2 == x0*a0 + x1*a1;
//  ensures (x0*a0 + x1*a1 + x2*a2) % a2 / a1 == x1;
//  ensures (x0*a0 + x1*a1 + x2*a2) % a2 % a1 == x0*a0;
//  ensures (x0*a0 + x1*a1 + x2*a2) % a2 % a1 / a0 == x0;
//  ensures \result;
//  decreases;
// pure bool lemma3d(
//  int x0, int a0, int n0,
//  int x1, int a1, int n1,
//  int x2, int a2, int n2
// );
...
//   x2, a2, n2
//  );
//  ensures b <= \result && \result < a0*n0 + a1*n1 + a2*n2 + b;
//  ensures (\result-b) / a2 == x2;
//  ensures (\result-b) % a2 == x0*a0 + x1*a1;
//  ensures (\result-b) % a2 / a1 == x1;
//  ensures (\result-b) % a2 % a1 == x0*a0;
//  ensures (\result-b) % a2 % a1 / a0 == x0;
//  decreases;
// pure int acc3d(
//  int x0, int a0, int n0,
//  int x1, int a1, int n1,
